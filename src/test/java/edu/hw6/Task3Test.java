...
public class Task3Test {
    static Arguments[] directoryPathsWithRegexAns() {
        return new Arguments[] {
            Arguments.of(
                Path.of(
                    "C:\\Users\\ullle\\IdeaProjects\\java-course-2023\\src\\test\\java\\edu\\hw6\\TestDirectories\\b1234"),
                List.of("Tinkoff Bank Biggest Secret.txt")
            ),
            Arguments.of(
                Path.of(
                    "C:\\Users\\ullle\\IdeaProjects\\java-course-2023\\src\\test\\java\\edu\\hw6\\TestDirectories\\firstDirectory"),
                List.of(
            ...
            Arguments.of(
                Path.of(
                    "C:\\Users\\ullle\\IdeaProjects\\java-course-2023\\src\\test\\java\\edu\\hw6\\TestDirectories\\Folder"),
                List.of()
            ),
            Arguments.of(
                Path.of(
                    "C:\\Users\\ullle\\IdeaProjects\\java-course-2023\\src\\test\\java\\edu\\hw6\\TestDirectories\\secondDirectory"),
                List.of("tocopyfile.txt")
            ),
            Arguments.of(
                Path.of(
                    "C:\\Users\\ullle\\IdeaProjects\\java-course-2023\\src\\test\\java\\edu\\hw6\\TestDirectories\\thirdDirectory"),
                List.of()
            ),
        };
    }
